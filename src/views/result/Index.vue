  ...
  <div class="container">
    ...
    <div class="main">
      <div class="resultArea">
        ...
        <div class="resultList" v-for="{item, index} in hit_list" :key="index">
          <div class="resultItem">
            ...
            <div class="itemBody">{{ item.content }}}</div>
            <div class="itemFoot">
                                    <span class="info">
                                        <label>发送人：</label>
...
export default {
  ...
  methods: {
    ...
    addSearch() {
      ...
      // window.location.href = "http://dataai.pro/result?q=" + this.keywords
    }
  }
}
</script>
